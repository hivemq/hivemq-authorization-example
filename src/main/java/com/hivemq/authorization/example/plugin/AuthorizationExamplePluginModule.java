 ...
 */
@Information(name = "HiveMQ Authorization Example Plugin", author = "Christian Goetz", version = "1.0-SNAPSHOT")
public class AuthorizationExamplePluginModule extends HiveMQPluginModule {
